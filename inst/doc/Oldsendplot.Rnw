% \VignetteIndexEntry{Old Quick Tutorial}
% \VignetteDepends{sendplot}
% \VignetteKeyword{old.sendplot}
% \VignetteKeyword{old.tutorial}
% \VignetteKeyword{old.wrappers}
...
\indent {\bf{Note:}} Again, the function assumes the data.frame rows are in the same order as they appear in the x argument (or y argument if y.links).  \newline
...
\indent {\bf{Note:}} as shown with the example, the function assumes the data.frame rows are in the same order as they appear in the x argument (or y argument if y.links).  \newline
...
\indent {\bf{Note:}} the function assumes the data.frame rows are in the same order as they appear in the x argument (or y argument if y.links).  \newline

\vspace{5mm}

\indent {\bf{Note:}} Please refer to section 3.2 for more details. 
